...
CPPPATH_NODE = '/Users/nsy/.nodebrew/node/v0.8.11/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g', '-Wall', '-O3']
...
LIBDIR = ':./lib/node:./lib/node'
LIBPATH_HIREDIS = '../deps/hiredis'
LIBPATH_NODE = '/Users/nsy/.nodebrew/node/v0.8.11/lib'
LIBPATH_ST = '-L%s'
LIB_HIREDIS = 'hiredis'
LIB_ST = '-l%s'
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = ':./lib/node:./lib/node'
PREFIX = '/usr/local'
PREFIX_NODE = '/Users/nsy/.nodebrew/node/v0.8.11'
